...
const addBrandForm = <div class="w-[928px] h-[1202px] absolute bg-white rounded-[20px]  top-[328px] left-[256px] border shadow-[0_9px_0px_0px_rgba(0,0,0,0.8)]">
<div class="p-5 left-[320px] top-[26px] absolute bg-white rounded-[20px] justify-center items-center gap-2.5 inline-flex ">
        <div class="text-slate-900 text-[32px] font-semibold">Add new brand</div>
    </div>
    ...
    <div class="left-[171px] top-[186px] absolute flex-col justify-start items-start gap-7 inline-flex  h-[733px] w-[587px]">
        <div class="flex-col justify-start items-start gap-[26px] flex">
            <div class="h-[102px] flex-col justify-start items-start gap-3 flex">
                <div class="justify-start items-center gap-2.5 inline-flex">
                    <div class="text-slate-900 text-xl font-medium font-[Poppins]">Brand Name</div>
                </div>
        ...
        <div class="self-stretch flex-col justify-start items-start gap-[26px] flex ">
            <div class="h-[124px] w-[587px] flex-col justify-start items-start gap-3 flex">
                <div class="justify-start items-center gap-2.5 inline-flex">
                    <div class="text-slate-900 text-xl font-medium font-[Poppins]">What do you like to write about?</div>
                </div>
                <input class="self-stretch px-9 py-3 rounded-[11px] border border-gray-400 justify-start items-start gap-2.5 inline-flex w-[587px] h-[82px]">
        ...
        <div class="self-stretch flex-col justify-start items-start gap-[26px] flex">
            <div class="h-[124px] flex-col justify-start items-start gap-3 flex">
                <div class="justify-start items-center gap-2.5 inline-flex">
                    <div class="text-slate-900 text-xl font-medium font-[Poppins]">Who are your target audiences?</div>
                </div>
                <input class="self-stretch px-9 py-3 rounded-[11px] border border-gray-400 justify-start items-start gap-2.5 inline-flex w-[587px] h-[82px]">
            ...
            <div class="flex-col justify-start items-start gap-2.5 inline-flex">
                <div class="h-[106px] flex-col justify-start items-start gap-4 flex">
                    <div class="justify-center items-center gap-[22px] inline-flex">
                        <div class="text-slate-900 text-xl font-medium">What language do you write in?</div>
                    </div>
                    <div class=" rounded-[11px] border border-gray-400  inline-flex w-[587px]">
                    <select class="w-[587px] text-slate-900 text-xl rounded-[11px] border border-gray-400  font-normal bg-white leading-9 tracking-tight h-[60px] self-stretch font-[Poppins]"  id="Select" name="Languages">
    ...
    <option value="es">Spanish - español</option>
        ...
        <div class="flex-col justify-start items-start gap-[13px]  h-[165px] w-[122px]  flex">
            <div class="justify-start items-center gap-2.5 inline-flex">
                <div class="text-slate-900 text-xl font-medium font-[Poppins] leading-[30px] text-[20px]">Add Logo</div>
            </div>
