...
export default function CalenderPopUp() {
  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col space-y-[1rem] justify-center  h-screen items-center  fixed z-[50000] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex space-x-[1rem] sm:divide-x ">
          <div className="w-[32rem]  bg-white rounded-2xl px-[2rem] py-[1.5rem]">
          ...
          <div className=" w-[7.56rem] bg-white rounded-2xl pt-[1.56rem] pb-[2.19rem] px-[0.81rem] flex space-x-[0.5rem]">
            {/**am */}
        ...
        <div className="w-[40.56rem] bg-white pl-[2.25rem] pr-[1.37rem] py-[0.62rem] flex items-center rounded-xl">
          <p className="text-[0.9375rem] text-[#151544] mr-[1.25rem] font-medium">
            Date
          </p>

          <div className="p-[0.62rem] text-[#151544] font-medium bg-[#E4E4E4] rounded-xl text-[1rem] mr-[0.25rem] text-center">
            23
          </div>

          <div className="p-[0.62rem] text-[#151544] font-medium bg-[#E4E4E4] rounded-2xl text-[1rem] mr-[4.31rem]">
            July 2023
          </div>

          <p className=" text-[#151544] font-normal mr-[1.25rem] text-[0.83756rem]">
            Time
          </p>

          <div className="p-[0.62rem] text-[#151544] font-medium bg-[#E4E4E4] rounded-xl text-[1rem] mr-[0.25rem] w-[2.875rem] text-center">
            9
          </div>

          <div className=" text-[#151544]  mr-[0.25rem] text-[1rem] font-medium">
            :
          </div>
          ...
          <div className="p-[0.62rem] text-[#151544] font-medium bg-[#E4E4E4] rounded-xl text-[1rem] mr-[0.69rem] w-[2.875rem] text-center">
            AM
          </div>

          <div className="text-white bg-[#07BD65] p-[0.625rem] w-[6.5625rem] text-center rounded-xl text-[1rem] font-medium">
            Save
          </div>
        </div>
      </div>
